...
// method to calculate the shoertest and longest word
...
if(ans[i][0]!=null){
String temp=ans[i][0];
if(s1.length()<temp.length())s1=ans[i][0]; // storing lonegest element

else if(s.length()>temp.length())s2=ans[i][0]; //storing smallest element
